            ...
            case CAMERA_REQ_CODE:{
                if(grantResults.length>0){
                    ...
                    if(cameraAccepted && storageAccepted) {
                        ...
                        Toast.makeText(this, "permissions for camera and storage needed", Toast.LENGTH_SHORT).show();
                    }
                }
                else {
            ...
            case STORAGE_REQ_CODE:{
                if(grantResults.length>0){
                    ...
                    if(storageAccepted) {
                        ...
                        Toast.makeText(this, "permission for storage is needed", Toast.LENGTH_SHORT).show();
                    }
                }
                else {
